...
describe('Model module', () => {
    ...
    describe('#processKey', () => {
        ...
        it('should process equal symbol', () => {
            let calculateSpy = jest.spyOn(calculatorInstance, 'calculate').mockImplementation();
            const value = '=';
        ...
        it('should process c symbol', () => {
            let clearSpy = jest.spyOn(calculatorInstance, 'clearLastValue').mockImplementation();
            const value = 'c';
            calculatorInstance.processKey(value);
        ...
        it('should process memory symbols', () => {
            let processMemorySpy = jest.spyOn(calculatorInstance, 'processMemory').mockImplementation();
            const value = 'mr';
            calculatorInstance.processKey(value);
        ...
        it('should process convertible symbol', () => {
            let convertOperationSpy = jest.spyOn(calculatorInstance, 'convertOperation').mockImplementation();
            const value = 'e';
            calculatorInstance.processKey(value);
    ...
    describe('#calculate', () => {
        ...
        it('should process NaN output ', () => {
            ...
            let evaluateSpy = jest.spyOn(calculatorInstance, 'evaluate').mockImplementation(() => NaN);
        ...
        it('should process any other output ', () => {
            let getExpressionSpy = jest.spyOn(calculatorInstance, 'getExpression').mockImplementation();
            let evaluateSpy = jest.spyOn(calculatorInstance, 'evaluate').mockImplementation(() => 32);
            calculatorInstance.calculate();
    ...
    describe('#validate',()=>{
        ...
        it('should transform expresion with spaces at start and at end', function () {
            calculatorInstance.state.keysArr = ["(", "2", "+","3",")"];
            const result = calculatorInstance.validate();
    ...
    describe('#getExpression',()=>{
        it('should get expression',  () => {
            let setExpression = jest.spyOn(calculatorInstance,'setExpression').mockImplementation();
            calculatorInstance.state.keysArr = ['1','+','3'];
