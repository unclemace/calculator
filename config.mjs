...
export const keysEngineer = {
    ...
    '2nd':{type:'operator',value:'2^',rowId:3,position:0,binary: false, priority:3, convertible:true, prefix: true },
    'square':{type:'operator',value:'^2',rowId:3,position:1, binary: false, priority: 3, convertible:true, prefix: false},
    'cube':{type:'operator',value:'^3',rowId:3,position:2, binary: false, priority:3 , convertible:true, prefix: false},
    'xy':{type:'operator',value:'^',rowId:3,position:3, binary: true, priority: 3},
    'ex':{type:'operator',value:'e^',rowId:3,position:4, binary: false, priority: 3, convertible:true, prefix: true },
    '10x':{type:'operator',value:'10^',rowId:3,position:5, binary: false, priority: 3, convertible:true, prefix: true },
    ...
    'sin':{type:'operator',value:'sin',rowId:1,position:1, binary: false, priority: 3, prefix: true },
    'cos':{type:'operator',value:'cos',rowId:1,position:2, binary: false, priority: 3, prefix: true },
    'tan':{type:'operator',value:'tan',rowId:1,position:3, binary: false, priority: 3, prefix: true },
    ...
    'sinh':{type:'operator',value:'sinh',rowId:0,position:1, binary: false, priority: 3, prefix: true },
    'cosh':{type:'operator',value:'cosh',rowId:0,position:2, binary: false, priority: 3, prefix: true },
    'tanh':{type:'operator',value:'tanh',rowId:0,position:3, binary: false, priority: 3, prefix: true },
